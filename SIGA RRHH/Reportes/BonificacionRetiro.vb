...
Public Class BonificacionRetiro
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "cl.presidencia.Argo.Reportes.BonificacionRetiro.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedBonificacionRetiro
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As BonificacionRetiro = New BonificacionRetiro()
        rpt.Site = Me.Site
        Return rpt
    End Function
