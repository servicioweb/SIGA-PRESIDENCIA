...
Public Class rptResumenSalud
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "cl.presidencia.Argo.Reportes.rptResumenSalud.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptResumenSalud
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptResumenSalud = New rptResumenSalud()
        rpt.Site = Me.Site
        Return rpt
    End Function
