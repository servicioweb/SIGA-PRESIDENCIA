...
Public Class rptEgresoViatico
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "cl.presidencia.Argo.Reportes.rptEgresoViatico.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptEgresoViatico
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptEgresoViatico = New rptEgresoViatico()
        rpt.Site = Me.Site
        Return rpt
    End Function
