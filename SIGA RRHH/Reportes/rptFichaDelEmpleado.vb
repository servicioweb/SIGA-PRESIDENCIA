...
Public Class rptFichaDelEmpleado
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptFichaDelEmpleado.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "cl.presidencia.Argo.Reportes.rptFichaDelEmpleado.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Selector_de_empleado() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptFichaDelEmpleado
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptFichaDelEmpleado = New rptFichaDelEmpleado()
        rpt.Site = Me.Site
        Return rpt
    End Function
