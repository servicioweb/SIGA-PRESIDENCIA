...
Public Class rptPlanillaCotPrev
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "cl.presidencia.Argo.Reportes.rptPlanillaCotPrev.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPlanillaCotPrev
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPlanillaCotPrev = New rptPlanillaCotPrev()
        rpt.Site = Me.Site
        Return rpt
    End Function
