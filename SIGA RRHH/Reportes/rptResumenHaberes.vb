...
Public Class rptResumenHaberes
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "cl.presidencia.Argo.Reportes.rptResumenHaberes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptResumenHaberes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptResumenHaberes = New rptResumenHaberes()
        rpt.Site = Me.Site
        Return rpt
    End Function
