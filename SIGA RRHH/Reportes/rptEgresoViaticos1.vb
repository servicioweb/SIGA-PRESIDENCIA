...
Public Class rptEgresoViaticos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "cl.presidencia.Argo.Reportes.rptEgresoViaticos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptEgresoViaticos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptEgresoViaticos = New rptEgresoViaticos()
        rpt.Site = Me.Site
        Return rpt
    End Function
