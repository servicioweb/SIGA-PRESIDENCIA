...
Public Class rptFichaEmpleado
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "cl.presidencia.Argo.Reportes.rptFichaEmpleado.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptFichaEmpleado
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptFichaEmpleado = New rptFichaEmpleado()
        rpt.Site = Me.Site
        Return rpt
    End Function
