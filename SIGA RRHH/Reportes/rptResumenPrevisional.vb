...
Public Class rptResumenPrevisional
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptResumenPrevisional.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "cl.presidencia.Argo.Reportes.rptResumenPrevisional.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptResumenPrevisional
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptResumenPrevisional = New rptResumenPrevisional()
        rpt.Site = Me.Site
        Return rpt
    End Function
