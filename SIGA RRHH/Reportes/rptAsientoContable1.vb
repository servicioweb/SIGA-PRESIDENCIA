...
Public Class rptAsientoContable
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "cl.presidencia.Argo.Reportes.rptAsientoContable.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptAsientoContable
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptAsientoContable = New rptAsientoContable()
        rpt.Site = Me.Site
        Return rpt
    End Function
