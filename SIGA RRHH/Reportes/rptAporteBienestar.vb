...
Public Class rptAporteBienestar
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "cl.presidencia.Argo.Reportes.rptAporteBienestar.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptAporteBienestar
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptAporteBienestar = New rptAporteBienestar()
        rpt.Site = Me.Site
        Return rpt
    End Function
