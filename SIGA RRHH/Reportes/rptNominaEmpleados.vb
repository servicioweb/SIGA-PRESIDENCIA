...
Public Class rptNominaEmpleados
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "cl.presidencia.Argo.Reportes.rptNominaEmpleados.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptNominaEmpleados
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptNominaEmpleados = New rptNominaEmpleados()
        rpt.Site = Me.Site
        Return rpt
    End Function
