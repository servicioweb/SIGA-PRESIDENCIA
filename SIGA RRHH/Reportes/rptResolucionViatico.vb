...
Public Class rptResolucionViatico
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptResolucionViatico.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "cl.presidencia.Argo.Reportes.rptResolucionViatico.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_copiaResolucion() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptResolucionViatico
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptResolucionViatico = New rptResolucionViatico()
        rpt.Site = Me.Site
        Return rpt
    End Function
