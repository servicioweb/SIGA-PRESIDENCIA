...
Public Class rptLibroHonorarios
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "cl.presidencia.Argo.Reportes.rptLibroHonorarios.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptLibroHonorarios
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptLibroHonorarios = New rptLibroHonorarios()
        rpt.Site = Me.Site
        Return rpt
    End Function
