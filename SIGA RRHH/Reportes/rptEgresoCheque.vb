...
Public Class rptEgresoCheque
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "cl.presidencia.Argo.Reportes.rptEgresoCheque.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptEgresoCheque
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptEgresoCheque = New rptEgresoCheque()
        rpt.Site = Me.Site
        Return rpt
    End Function
