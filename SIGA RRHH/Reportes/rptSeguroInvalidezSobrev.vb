...
Public Class rptSeguroInvalidezSobrev
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptSeguroInvalidezSobrev.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "cl.presidencia.Argo.Reportes.rptSeguroInvalidezSobrev.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_tipoProceso() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptSeguroInvalidezSobrev
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSeguroInvalidezSobrev = New rptSeguroInvalidezSobrev()
        rpt.Site = Me.Site
        Return rpt
    End Function
