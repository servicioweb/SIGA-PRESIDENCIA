...
Public Class rptChequeCarta
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "cl.presidencia.Argo.Reportes.rptChequeCarta.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptChequeCarta
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptChequeCarta = New rptChequeCarta()
        rpt.Site = Me.Site
        Return rpt
    End Function
