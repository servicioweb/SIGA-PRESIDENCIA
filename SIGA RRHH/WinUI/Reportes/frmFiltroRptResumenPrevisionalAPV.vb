...
Public Class frmFiltroRptResumenPrevisionalAPV
...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        'btnCancelar
        '
        Me.btnCancelar.Location = New System.Drawing.Point(8, 72)
        ...
        Me.Name = "frmFiltroRptResumenPrevisionalAPV"
        Me.Text = "Resumen Previsional APV"
...
#End Region
    ...
    Private Sub btnVisualizar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnVisualizar.Click
        ...
        Dim reporte As New rptResumenPrevisionalAPV
        WinUI.UtilCrystalReports.UtilReport.setConnection(reporte)
        Dim strFormulaSeleccion As String = "{VW_IMPOSICIONES_APV.PERIODO_ID}=" & Me.cboPeriodo.SelectedValue
        reporte.SummaryInfo.ReportTitle = "Resumen de Pagos Cotizaciones Previsionales APV"
    ...
    Private Sub frmFiltroRptResumenPrevisionalAPV_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
