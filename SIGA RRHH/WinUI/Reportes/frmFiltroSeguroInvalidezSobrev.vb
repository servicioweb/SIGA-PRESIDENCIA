...
Public Class frmFiltroSeguroInvalidezSobrev
...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        '
        'frmFiltroSeguroInvalidezSobrev
        '
        ...
        Me.Name = "frmFiltroSeguroInvalidezSobrev"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Seguro de Invalidez y Sobrevivencia"
...
#End Region
    ...
    Private Sub btnVisualizar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnVisualizar.Click
        ...
        Dim reporte As New rptSeguroInvalidezSobrev
        ...
        Dim strFormulaSeleccion As String = "{VW_IMPOSICIONES.PERIODO_ID}=" & Me.cboPeriodo.SelectedValue '& " AND {VW_IMPOSICIONES.TIPO_PROCESO}=""" & Me.rdgTipoProceso.EditValue & """" & " AND {VW_IMPOSICIONES.MONTO_SEGURO_INVALIDEZ_SOBR}>0"
        strFormulaSeleccion &= " AND {VW_IMPOSICIONES.TIPO_PROCESO}=""" & Me.rdgTipoProceso.EditValue & """"
        strFormulaSeleccion &= " AND {VW_IMPOSICIONES.MONTO_SEGURO_INVALIDEZ_SOBR}>0"
