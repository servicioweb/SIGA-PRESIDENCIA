...
Public Class _frmFiltroLiquidaciones
    Inherits System.Windows.Forms.Form

#Region " Código generado por el Diseñador de Windows Forms "

    Public Sub New(ByVal firmar As Boolean)
        MyBase.New()
        'El Diseñador de Windows Forms requiere esta llamada.
        InitializeComponent()

        btnPDF.Visible = firmar
        pbPDF.Visible = firmar
...
#End Region
    ...
    Private Sub GenerarReportes(ByVal Empleado As Integer, ByVal Periodo As Integer, ByVal Calculo As String, ByVal Folder As String, ByVal nArchivo As String, ByVal idEmpleado As String, ByVal Mes As String, ByVal Anno As String)
        ...
        Try
            ...
            cryRpt.Close()
            Dim up As _TransferPictures = New _TransferPictures
    ...
    Private Sub btnPDF_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPDF.Click
        Dim obj As New Sign.Sign(Comun.ArgoConfiguracion.ConnectionString, cl.presidencia.Seguridad.NombreUsuario)
        If Not obj.CompruebaUsuario(cl.presidencia.Seguridad.NombreUsuario) Then
            MessageBox.Show("Usted no posee Firma Digital para firmar Liquidaciones de Sueldo", "ERROR", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Return
        End If
...
Public Class _TransferPictures
    ''' <summary>
    ...
    Public Function UploadFile(ByVal FileName As String) As Long
        ...
        Try
            ...
            Try
                Dim obj As New Sign.Sign(Comun.ArgoConfiguracion.ConnectionString, cl.presidencia.Seguridad.NombreUsuario)
                If obj.TestSP() Then ' And obj.TWS()
                    path_log = Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments)

                    inicio = DateTime.Now
                    aa = Convert.ToBoolean(obj.FSSL(FileName))
                    fin = DateTime.Now
                End If
            ...
            Dim strPrint = FileName + vbTab + aa.ToString + vbTab + totalMin

            path_log = path_log + "\LogSIGA"
            If Directory.Exists(path_log) = False Then
                Directory.CreateDirectory(path_log)
            End If

            Dim sw As New StreamWriter(path_log + "\log.txt", True)
            sw.WriteLine(DateTime.Now.ToString + vbTab + strPrint)
            sw.Flush()
            sw.Close()
