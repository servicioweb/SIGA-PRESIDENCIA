...
Public Class frmSuplementariaDiferecias
...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    Friend WithEvents prsSuplementaria As DevExpress.XtraPrinting.PrintingSystem
    Friend WithEvents PrintableComponentLink1 As DevExpress.XtraPrinting.PrintableComponentLink
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Me.components = New System.ComponentModel.Container()
        Dim StyleFormatCondition1 As DevExpress.XtraGrid.StyleFormatCondition = New DevExpress.XtraGrid.StyleFormatCondition()
        Dim StyleFormatCondition2 As DevExpress.XtraGrid.StyleFormatCondition = New DevExpress.XtraGrid.StyleFormatCondition()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmSuplementariaDiferecias))
        ...
        Me.prsSuplementaria = New DevExpress.XtraPrinting.PrintingSystem(Me.components)
        ...
        CType(Me.prsSuplementaria, System.ComponentModel.ISupportInitialize).BeginInit()
        ...
        Me.btnImprimir.Anchor = CType(((System.Windows.Forms.AnchorStyles.Top Or System.Windows.Forms.AnchorStyles.Left) _
            Or System.Windows.Forms.AnchorStyles.Right), System.Windows.Forms.AnchorStyles)
        Me.btnImprimir.Location = New System.Drawing.Point(544, 48)
        ...
        'MONTO_HISTORICO
        '
        Me.MONTO_HISTORICO.Caption = "Monto Cálculo Normal"
        ...
        'MONTO_RELIQUIDADO
        '
        Me.MONTO_RELIQUIDADO.Caption = "Monto Cálculo Suplemen."
        ...
        Me.MONTO_RELIQUIDADO.Width = 133
        '
        ...
        'prsSuplementaria
        '
        Me.prsSuplementaria.Links.AddRange(New Object() {Me.PrintableComponentLink1})
        '
        ...
        CType(Me.prsSuplementaria, System.ComponentModel.ISupportInitialize).EndInit()
...
#End Region
    ...
    Private Sub luePeriodo_EditValueChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles luePeriodo.EditValueChanged
        ...
        If luePeriodo.EditValue <> Nothing Then
            repositorio.dvEmpleadosReliquidados.RowFilter = "TIPO_PROCESO='" + tipoProceso + "' AND PERIODO_ID=" & luePeriodo.EditValue
    ...
    Private Sub refrescaDetalle()
        If gleRut.EditValue <> Nothing And luePeriodo.EditValue <> Nothing Then
            gdcDetalleItems.DataSource = empleado.dvReliquidacionEmpleado(CType(gleRut.EditValue, Integer), CType(luePeriodo.EditValue, Integer), tipoProceso)
    ...
    Private Sub PrintableComponentLink1_CreateReportHeaderArea(ByVal sender As System.Object, ByVal e As DevExpress.XtraPrinting.CreateAreaEventArgs) Handles PrintableComponentLink1.CreateReportHeaderArea
        ...
        Dim reportHeader As String = "EMPLEADO : " & empleado.nombreCompleto & " SUPLEMENTARIA : " & "PERIODO " & row("DESCRIPCION_PERIODO")
