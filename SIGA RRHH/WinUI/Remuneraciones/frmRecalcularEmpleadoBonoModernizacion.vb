...
Public Class frmRecalcularEmpleadoBonoModernizacion
...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    Friend WithEvents luePeriodoBono As DevExpress.XtraEditors.LookUpEdit
    Friend WithEvents lblPeriodoBono As System.Windows.Forms.Label
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Me.gpcEncabezado = New DevExpress.XtraEditors.GroupControl
        Me.luePeriodoBono = New DevExpress.XtraEditors.LookUpEdit
        Me.lblPeriodoBono = New System.Windows.Forms.Label
        ...
        CType(Me.luePeriodoBono.Properties, System.ComponentModel.ISupportInitialize).BeginInit()
        ...
        Me.gpcEncabezado.Controls.Add(Me.luePeriodoBono)
        Me.gpcEncabezado.Controls.Add(Me.lblPeriodoBono)
        ...
        'luePeriodoBono
        '
        Me.luePeriodoBono.EnterMoveNextControl = True
        Me.luePeriodoBono.Location = New System.Drawing.Point(184, 56)
        Me.luePeriodoBono.Name = "luePeriodoBono"
        '
        'luePeriodoBono.Properties
        '
        Me.luePeriodoBono.Properties.Buttons.AddRange(New DevExpress.XtraEditors.Controls.EditorButton() {New DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo)})
        Me.luePeriodoBono.Size = New System.Drawing.Size(112, 20)
        Me.luePeriodoBono.TabIndex = 9
        '
        'lblPeriodoBono
        '
        Me.lblPeriodoBono.Location = New System.Drawing.Point(16, 60)
        Me.lblPeriodoBono.Name = "lblPeriodoBono"
        Me.lblPeriodoBono.Size = New System.Drawing.Size(152, 16)
        Me.lblPeriodoBono.TabIndex = 8
        Me.lblPeriodoBono.Text = "Período Bono Modernización"
        Me.lblPeriodoBono.TextAlign = System.Drawing.ContentAlignment.TopRight
        '
        'Progreso
        '
        ...
        'luePeriodo
        '
        Me.luePeriodo.Location = New System.Drawing.Point(184, 32)
        ...
        'lblPeriodo
        '
        Me.lblPeriodo.Location = New System.Drawing.Point(96, 36)
        ...
        '
        'frmRecalcularEmpleadoBonoModernizacion
        '
        ...
        Me.Name = "frmRecalcularEmpleadoBonoModernizacion"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Recalcular Asignaciones Base"
        Me.WindowState = System.Windows.Forms.FormWindowState.Maximized
        CType(Me.gpcEncabezado, System.ComponentModel.ISupportInitialize).EndInit()
        Me.gpcEncabezado.ResumeLayout(False)
        CType(Me.luePeriodoBono.Properties, System.ComponentModel.ISupportInitialize).EndInit()
...
#End Region
    ...
    Dim parametroMensual, periodoHistorico, periodoBono As Periodo
    Dim estadoPeriodo As Boolean
    Dim filaSinError As Boolean
    Dim anoBono, mesBono As Integer
    ...
    Private Sub llenarPeriodoBono()
        With luePeriodoBono
            ...
            End With
        End With
        luePeriodoBono.Properties.DataSource = repositorio.dvPeriodoBono
        luePeriodoBono.Properties.DisplayMember = "DESCRIPCION_PERIODO"
        luePeriodoBono.Properties.NullText = ""
        luePeriodoBono.Properties.PopupWidth = 150
        luePeriodoBono.Properties.ValueMember = "PERIODO_ID"
    End Sub
    ...
    Public Sub llenarEmpleado()
        ...
        gleRut.DataSource = repositorio.dvEmpleadosPlantaContrataActivosInactivos
    ...
    Private Sub luePeriodo_EditValueChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles luePeriodo.EditValueChanged
        ...
        If Not IsNothing(row) Then
            ...
            Else
                gdcBonoModernizacion.Enabled = True
                btnGenera.Enabled = True
                If gdvDetalleBonos.RowCount > 0 And (Not IsNothing(luePeriodoBono.EditValue)) Then
                    btnGeneraAsignaciones.Enabled = True
                Else
                    btnGeneraAsignaciones.Enabled = False
                End If
        ...
        End If
    End Sub
    Private Sub luePeriodoBono_EditValueChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles luePeriodoBono.EditValueChanged
        Dim editor As DevExpress.XtraEditors.LookUpEdit = CType(sender, DevExpress.XtraEditors.LookUpEdit)
        Dim row As DataRowView = CType(editor.Properties.GetDataSourceRowByKeyValue(editor.EditValue), DataRowView)
        If luePeriodoBono.EditValue <> Nothing Then
            If Not IsNothing(row) Then
                anoBono = row("ANO")
                mesBono = row("MES")
                btnGeneraAsignaciones.Enabled = True
    ...
    Private Sub btnGeneraAsignaciones_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGeneraAsignaciones.Click
        ...
        parametroMensual = New Periodo(anoBono, mesBono)
        periodoBono = New Periodo(anoBono, mesBono)
        ...
        Try
            If MessageBox.Show("¿Está seguro que desea iniciar el reproceso para mes " & nombrePeriodo & "?", "Remuneraciones", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
                ...
                Dim origen As Integer = 4
                Dim tipoProceso As String = "R"
                Dim empleado As empleado
                ...
                For i = 0 To filas.Length - 1
                    ...
                    empleado = New empleado(row("EMPLEADO_ID"), periodoBono.ID)
                    Try
                        ...
                        Remuneracion.calculaRemuneracion(empleado, wb, "N", parametroMensual, reliquidaBonos)

                        'Genera los ítems para los dos meses históricos mas el actual
                        If empleado.generarItemsBonoModernizacion(row("EMPLEADO_ID"), periodoBono.ID, periodoBono.ano, periodoBono.mes, _
                                            periodoBono.itemBonoDesempenoMesActual, periodoBono.itemBonoDesempenoMes1, _
                                            periodoBono.itemBonoDesempenoMes2, periodoBono.itemBonoLey19553Art8MesActual, _
                                            periodoBono.itemBonoLey19553Art8Mes1, periodoBono.itemBonoLey19553Art8Mes2, _
                                            periodoBono.itemBonoDesctoBienestarMes1, periodoBono.itemBonoDesctoBienestarMes2, _
                                            periodoBono.porcentajeDesctoBienestar, empleado.datosPrevisionales.institucionID, empleado.datosSalud.institucionID, _
                                            row("BASE_BONO"), row("INSTITUCIONAL"), row("COLECTIVO"), row("TOTAL"), _
                                            periodoBono.itemBonoDistribucionBase, periodoBono.itemBonoDistribucionInstitucional, _
                                            periodoBono.itemBonoDistribucionColectivo, empleado, tipoProceso, "N", periodoBono.itemAsigLey19863Mes1, _
                                            periodoBono.itemAsigLey19863Mes2, periodoBono.itemAsigLey19863MesActual, False, 0, 0, _
                                            parametroMensual.aplicaAsignacionZona, MontoZonaExtrema40, MontoZonaExtrema60, MontoBonoZonaExtrema) Then

                            mesProceso = periodoBono.mes - 2
                            anoProceso = periodoBono.ano
                            For j = 1 To 1
                                For k = 0 To 1
                                    reliquidaBonos = True
                                    ...
                                    Remuneracion.calculaRemuneracion(empleado, wb, "R", periodoHistorico, reliquidaBonos)
                                    empleado.CrearEmpleadoReliquidadoBonoModernidad(parametroMensual.ID, periodoHistorico.ID, empleado.ID, tipoProceso)
                                    mesProceso += 1
                                Next k
                        ...
                        Try
                            If empleado.CrearItemReliquidado(CType(parametroMensual.ID, Integer), CType(row("EMPLEADO_ID"), Integer), "R") Then
                                empleado = New empleado(row("EMPLEADO_ID"), parametroMensual.ID)
                                Remuneracion.calculaRemuneracion(empleado, wb, "R", parametroMensual, reliquidaBonos)
                            End If
                        Catch ex As Exception
