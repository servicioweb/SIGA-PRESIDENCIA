...
Public Class frmPermisoAdministrativoSinGoceSueldo
...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmPermisoAdministrativoSinGoceSueldo))
        ...
        Me.txtNombres.Location = New System.Drawing.Point(120, 73)
        ...
        Me.lblNombres.Location = New System.Drawing.Point(8, 73)
        Me.lblNombres.Name = "lblNombres"
        Me.lblNombres.Size = New System.Drawing.Size(96, 16)
        Me.lblNombres.TabIndex = 64
        ...
        Me.lblRut.Location = New System.Drawing.Point(8, 48)
        Me.lblRut.Name = "lblRut"
        Me.lblRut.Size = New System.Drawing.Size(96, 16)
        Me.lblRut.TabIndex = 62
        Me.lblRut.Text = "Rut"
        ...
        Me.glerut.EditValue = ""
        Me.glerut.Location = New System.Drawing.Point(120, 48)
        ...
        Me.btnEmiteDetalle.Anchor = CType(((System.Windows.Forms.AnchorStyles.Top Or System.Windows.Forms.AnchorStyles.Left) _
            Or System.Windows.Forms.AnchorStyles.Right), System.Windows.Forms.AnchorStyles)
        Me.btnEmiteDetalle.Location = New System.Drawing.Point(520, 56)
        ...
        Me.txtEstadoEmpleado.Location = New System.Drawing.Point(344, 99)
        ...
        'lblEstadoEmpleado
        '
        Me.lblEstadoEmpleado.Location = New System.Drawing.Point(232, 107)
        ...
        Me.txtFechaIngreso.Location = New System.Drawing.Point(120, 99)
        ...
        'luePeriodo
        '
        Me.luePeriodo.Location = New System.Drawing.Point(120, 22)
        ...
        'lblPeriodo
        '
        Me.lblPeriodo.Location = New System.Drawing.Point(56, 26)
        ...
        Me.gdcPermisoAdmin.RepositoryItems.AddRange(New DevExpress.XtraEditors.Repository.RepositoryItem() {Me.dedFechaInicio, Me.txtdiasHabiles, Me.lueTipoJornada})
        ...
        Me.gdvDetallePermisoAdmin.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.EVENTO_ADMINISTRATIVO_DET_ID, Me.EVENTO_ADMINISTRATIVO_ID, Me.FECHA_NACIMIENTO_HIJO, Me.DIAS_HABILES, Me.FECHA_INICIO, Me.FECHA_TERMINO, Me.JORNADA_ID, Me.DIAS_RECORRIDO, Me.FECHA_REGRESO, Me.RESOLUCION, Me.OBSERVACION, Me.FECHA_DIGITACION, Me.PERIODO_ID, Me.USUARIO, Me.TIPO_FALLECIMIENTO_ID})
        ...
        'DIAS_HABILES
        '
        Me.DIAS_HABILES.Caption = "Cantidad de Días"
        ...
        '
        'frmPermisoAdministrativoSinGoceSueldo
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
        Me.ClientSize = New System.Drawing.Size(832, 486)
        Me.Controls.Add(Me.gdcPermisoAdmin)
        Me.Controls.Add(Me.gpcEncabezado)
        Me.Name = "frmPermisoAdministrativoSinGoceSueldo"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Permiso Administrativo Empleado Sin Goce Sueldo"
...
#End Region
    ...
    Private eventoAdmin As Integer = Comun.TiposDeDatos.TipoEventoAdmin.PERMISO_SIN_GOCE_SUELDO
    ...
    Private Sub refrescaDetalle()
        If luePeriodo.EditValue <> Nothing And glerut.EditValue <> Nothing Then
            ...
            Catch ex As Exception
                MsgBox("Ha ocurrido un error al leer datos permiso sin goce sueldo. ERROR: " & ex.Message, MsgBoxStyle.Exclamation)
            End Try
        End If
    End Sub
    ...
    Private Sub gdvDetallePermisoAdmin_RowUpdated(ByVal sender As System.Object, ByVal e As DevExpress.XtraGrid.Views.Base.RowObjectEventArgs) Handles gdvDetallePermisoAdmin.RowUpdated
        ...
        Dim eventoAdminId As Integer = view.GetRowCellValue(view.FocusedRowHandle, "EVENTO_ADMINISTRATIVO_ID")
    ...
    Private Sub gdvDetallePermisoAdmin_ValidateRow(ByVal sender As System.Object, ByVal e As DevExpress.XtraGrid.Views.Base.ValidateRowEventArgs) Handles gdvDetallePermisoAdmin.ValidateRow
        ...
        If respuesta Then
            ...
            If diasHabiles = 0 Then
                e.Valid = False
                MessageBox.Show("Falta ingresar cantidad de días", "SIGA", MessageBoxButtons.OK, MessageBoxIcon.Error)
                Exit Sub
            End If
    ...
    Private Sub dedFechaInicio_Validating(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles dedFechaInicio.Validating
        ...
        If FechaDateEditControl.EditValue <> Nothing Then

            Dim fechaFinalFeriado As Date
            Dim fechaRetornoFeriado As Date
            Try
                fechaFinalFeriado = Comun.Funciones.FechaFinal.Valida(FechaDateEditControl.EditValue, diasHabilesSolicitados)
    ...
    Private Sub txtdiasHabiles_Validating(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles txtdiasHabiles.Validating
        ...
        If diasHabilesSolicitados > 0 And Not view.IsNewItemRow(view.FocusedRowHandle) Then
            e.Cancel = True
            MessageBox.Show("Para modificar días permiso administrativo sin goce sueldo, debe eliminar el registro y volver a ingresarlo", "Permiso Administrativo", MessageBoxButtons.OK, MessageBoxIcon.Warning)
        Else
