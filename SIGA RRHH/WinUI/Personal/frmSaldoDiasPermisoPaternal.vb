...
Public Class frmSaldoDiasPermisoPaternal
    Inherits System.Windows.Forms.Form
    Private Shared _Form As frmSaldoDiasPermisoPaternal = Nothing

    Public Shared Property DefInstance() As frmSaldoDiasPermisoPaternal
        Get
            If _Form Is Nothing OrElse _Form.IsDisposed Then
                _Form = New frmSaldoDiasPermisoPaternal
            Else
                _Form.BringToFront()
            End If
            Return _Form
        ...
        Set(ByVal value As frmSaldoDiasPermisoPaternal)
            _Form = value
        End Set
    End Property
...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.Name = "frmSaldoDiasPermisoPaternal"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Saldo de Dias Permiso Paternal"
        Me.TopMost = True
